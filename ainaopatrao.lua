...
if game:GetService("StarterGui") then  game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Eis que quando a 10/10 mim olha", "All")
end
...
section1:addButton("Send Message", function()
    game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("EIS QUE QUANDO A 10/10 MIM OLHA", "All")
end)
...
telelist = {"Spawn","Wood r' Us","Land Store","Wood Dropoff","Dock","Link's Logic","Cave","Volcano","Swamp","Palm Island","Fancy Furnishings","Boxed Cars","Fine Arts Shop","Bob's Shack","Bridge","End Times","Shrine Of Sight","The Den","Volcano Win","Ski Lodge","Strange Man"}
varbs.storeLoc = ""
